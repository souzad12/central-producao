...
final class PreparationPrompts {
  ...
  static String user(String payloadJson) {
    return "Prepare o episódio a partir deste pacote do aplicativo:\n" + payloadJson + "\n\n" +
      "Antes de estruturar o episódio, faça três decisões obrigatórias: (1) auditoria de não repetição usando editorialMemory; (2) auditoria de continuidade futura usando futureGuard; (3) escolha automática do motor de estilo mais adequado. " +
      ...
      "primary deve ser um dos motores permitidos; secondary pode ser vazio; intensity = 1|2|3|4|5. Em whyItFits explique por que o motor serve especificamente à pauta. Em traits liste 3 a 6 características; em guardrails liste limites contra exagero ou ficcionalização indevida. " +
