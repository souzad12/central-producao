...
final class PreparationPrompts {
  static String system() {
    return "Você é o motor Showrunner do Church History Studio. Prepare dramaturgia histórica rigorosa para episódios longos. " +
      ...
      "VOZ NARRATIVA AUTO: escolha também a perspectiva do narrador que melhor serve à pauta. Opções: TERCEIRA_PESSOA_HISTORICA; PRIMEIRA_PESSOA_PLURAL_INVESTIGATIVA (nós, nossa investigação, quando natural); SEGUNDA_PESSOA_RETORICA (uso pontual, nunca contínuo); ENSAISTICA_MISTA (terceira pessoa como base com nós/segunda pessoa apenas quando melhorarem clareza e envolvimento). " +
      "Nunca transforme personagem histórico em narrador fictício de primeira pessoa. Primeira pessoa singular só pode aparecer em citação ou documento realmente sustentado pelo pacote e claramente apresentado como tal. Não invente memória, confissão, pensamento ou testemunho. " +
  ...
  static String user(String payloadJson) {
    return "Prepare o episódio a partir deste pacote do aplicativo:\n" + payloadJson + "\n\n" +
      "Antes de estruturar o episódio, faça quatro decisões obrigatórias: (1) auditoria de não repetição usando editorialMemory; (2) auditoria de continuidade futura usando futureGuard; (3) escolha automática do motor de estilo mais adequado; (4) escolha automática da voz narrativa. " +
      "Para estilo, avalie natureza do conflito, escala histórica, guerra/política/instituições, interioridade realmente documentada, grau de disputa historiográfica, densidade teológica, ritmo de suspense e tipo de payoff. Não escolha DOSTOIEVSKIANO_HISTORICO por padrão. " +
      "Para voz narrativa, decida se a pauta funciona melhor em terceira pessoa histórica, primeira pessoa plural investigativa, segunda pessoa retórica pontual ou voz ensaística mista. Evite monotonia, mas nunca sacrifique precisão histórica. " +
      "O episódio atual precisa ter tese, conflito, abertura e payoff próprios. Se um evento anterior já dramatizado for indispensável, resuma-o. Se um tema pertence aos próximos episódios, reserve-o: não dramatize sua sequência central nem entregue sua resolução.\n\n" +
      ...
      "primary deve ser um dos motores permitidos; secondary pode ser vazio; intensity = 1|2|3|4|5. perspective deve ser TERCEIRA_PESSOA_HISTORICA|PRIMEIRA_PESSOA_PLURAL_INVESTIGATIVA|SEGUNDA_PESSOA_RETORICA|ENSAISTICA_MISTA. " +
      "Em whyItFits explique por que estilo e voz servem especificamente à pauta. Em traits liste 3 a 6 características; em guardrails e rules liste limites contra exagero, monotonia ou ficcionalização indevida. " +
